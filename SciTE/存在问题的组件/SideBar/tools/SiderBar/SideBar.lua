...
list_favorites:add_column("收藏夹", 220)
tab3:context_menu {
	'添加当前文件|Favorites_AddCurrentBuffer',
	'删除\tDel|Favorites_DeleteItem',
	'刷新|Bookmarks_RefreshTable',
	'',
	'隐藏侧边栏|SideBar_ShowHide',
...
list_bookmarks:add_column("书签", 196)
...
--^------- common patterns -------^--
	...
	do --v----- * ------v--
		-- redefine common patterns
		local NL = P"\r\n"+P"\n"+P"\f"
		local SC = S" \t\160" -- 160, SciTEGlobal.properties Warnings] 10 疣?
